...
class ProfileTest(unittest.TestCase):
    ...
    def test_get_value_position(self):
        ...
        self.assertTrue(np.all(res_a == res_a2))
    ...
    def test_get_extrema_position(self):
        ...
        self.assertTrue(np.all(res_a[0] == res_a2[0]))
        self.assertTrue(np.all(res_a[1] == res_a2[1]))
        #
        ...
        self.assertTrue(np.all(res_b[0] == res_b2[0]))
        self.assertTrue(np.all(res_b[1] == res_b2[1]))
